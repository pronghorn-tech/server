...
public sealed class ManagedByteBuffer {
    public abstract val buffer: ByteBuffer

    public abstract fun release()
}

public class ReusableByteBuffer(private val manager: ReusableBufferPoolManager,
...
public class OneUseByteBuffer(bufferSize: Int,
